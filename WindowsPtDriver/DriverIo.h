...
#define _KERNEL_TRACE_FROM_USER_MODE_ENABLED 1					// If or not to enable the KERNEL mode tracing from user mode
...
typedef struct _PT_USER_REQ {
	...
	BOOLEAN bTraceUser;						// TRUE if I need to trace even User mode components
