...
struct PT_TRACE_DESC {
	...
	BOOLEAN bTraceKernel;					// Trace by CPL: TRUE if I need to trace even Kernel mode components
	BOOLEAN bTraceUser;						// Trace by CPL: TRUE if I need to trace even User mode components
